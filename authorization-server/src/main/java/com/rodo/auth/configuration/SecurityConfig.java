package com.rodo.auth.configuration;
...
import com.rodo.auth.repositories.RolRepository;
import com.rodo.auth.repositories.UsuarioRepository;
import com.rodo.auth.services.CustomUserDetails;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(List.of("*")); // Permitimos todos los headers
        configuration.setAllowCredentials(true);

        UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
        source.registerCorsConfiguration("/**", configuration); // Aplica para TODO el proyecto
        return source;
    }
